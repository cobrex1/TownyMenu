...
public final class Settings extends SimpleSettings {
	...
	private static void init() {
		...
		FILLER_NATION_TOGGLE_CMD = getInteger("Filler_Nation_Toggle.CustomModelData");

		FILLER_NATION_EXTRA_INFO_MENU = getMaterial("Filler_Nation_Extra_Info_Menu.Item");
		FILLER_NATION_EXTRA_INFO_MENU_CMD = getInteger("Filler_Nation_Extra_Info_Menu.CustomModelData");

		FILLER_JOIN_TOWN_MENU = getMaterial("Filler_Join_Town_Menu.Item");
		FILLER_JOIN_TOWN_MENU_CMD = getInteger("Filler_Join_Town_Menu.CustomModelData");

		FILLER_TOWN_MENU = getMaterial("Filler_Town_Menu.Item");
		FILLER_TOWN_MENU_CMD = getInteger("Filler_Town_Menu.CustomModelData");
		FILLER_TOWN_TOGGLE = getMaterial("Filler_Town_Toggle.Item");
		FILLER_TOWN_TOGGLE_CMD = getInteger("Filler_Town_Toggle.CustomModelData");
		FILLER_TOWN_PERMS_MENU = getMaterial("Filler_Town_Perms_Menu.Item");
		FILLER_TOWN_PERMS_MENU_CMD = getInteger("Filler_Town_Perms_Menu.CustomModelData");
		FILLER_TOWN_ECONOMY_MENU = getMaterial("Filler_Economy_Menu.Item");
		FILLER_TOWN_ECONOMY_MENU_CMD = getInteger("Filler_Economy_Menu.CustomModelData");
		FILLER_TOWN_GENERAL_SETTINGS_MENU = getMaterial("Filler_Town_General_Settings_Menu.Item");
		FILLER_TOWN_GENERAL_SETTINGS_MENU_CMD = getInteger("Filler_Town_General_Settings_Menu.CustomModelData");
		FILLER_TOWN_EXTRA_INFO_MENU = getMaterial("Filler_Extra_Info_Menu.Item");
		FILLER_TOWN_EXTRA_INFO_MENU_CMD = getInteger("Filler_Extra_Info_Menu.CustomModelData");

		FILLER_PLOT_MENU = getMaterial("Filler_Plot_Menu.Item");
		FILLER_PLOT_MENU_CMD = getInteger("Filler_Plot_Menu.CustomModelData");
		FILLER_PLOT_TOGGLE_MENU = getMaterial("Filler_Plot_Toggle_Menu.Item");
		FILLER_PLOT_TOGGLE_MENU_CMD = getInteger("Filler_Plot_Toggle_Menu.CustomModelData");
		FILLER_PLOT_PERMS_MENU = getMaterial("Filler_Plot_Perms_Menu.Item");
		FILLER_PLOT_PERMS_MENU_CMD = getInteger("Filler_Plot_Perms_Menu.CustomModelData");
		...
		NATION_TOWN_LIST_CMD = getInteger("Nation_Town_List.CustomModelData");
		NATION_RESIDENT_MENU = getString("Nation_Resident_Menu.Item");
		NATION_RESIDENT_MENU_CMD = getInteger("Nation_Resident_Menu.CustomModelData");
		NATION_ECONOMY_MENU = getString("Nation_Economy_Menu.Item");
		NATION_ECONOMY_MENU_CMD = getInteger("Nation_Economy_Menu.CustomModelData");
		NATION_SETTINGS_MENU = getString("Nation_Settings_Menu.Item");
		NATION_SETTINGS_MENU_CMD = getInteger("Nation_Settings_Menu.CustomModelData");
		NATION_INVITE_TOWN_MENU = getString("Nation_Invite_Town.Item");
		NATION_INVITE_TOWN_MENU_CMD = getInteger("Nation_Invite_Town.CustomModelData");
		NATION_EXTRA_INFO = getString("Nation_Extra_Info.Item");
		NATION_EXTRA_INFO_CMD = getInteger("Nation_Extra_Info.CustomModelData");

		NATION_BALANCE = getString("Nation_Balance.Item");
		NATION_BALANCE_CMD = getInteger("Nation_Balance.CustomModelData");
		NATION_DEPOSIT = getString("Nation_Deposit.Item");
		NATION_DEPOSIT_CMD = getInteger("Nation_Deposit.CustomModelData");
		NATION_WITHDRAW = getString("Nation_Withdraw.Item");
		NATION_WITHDRAW_CMD = getInteger("Nation_Withdraw.CustomModelData");
		NATION_SET_TAX = getString("Nation_Set_Tax.Item");
		NATION_SET_TAX_CMD = getInteger("Nation_Set_Tax.CustomModelData");

		NATION_TOWN_KICK = getString("Nation_Town_Kick.Item");
		NATION_TOWN_KICK_CMD = getInteger("Nation_Town_Kick.CustomModelData");

		NATION_RESIDENT_RANK = getString("Nation_Resident_Rank.Item");
		NATION_RESIDENT_RANK_CMD = getInteger("Nation_Resident_Rank.CustomModelData");
		NATION_SET_KING = getString("Nation_Set_King.Item");
		NATION_SET_KING_CMD = getInteger("Nation_Set_King.CustomModelData");

		NATION_TOGGLE_PUBLIC = getString("Nation_Toggle_Public.Item");
		NATION_TOGGLE_PUBLIC_CMD = getInteger("Nation_Toggle_Public.CustomModelData");
		NATION_TOGGLE_OPEN = getString("Nation_Toggle_Open.Item");
		NATION_TOGGLE_OPEN_CMD = getInteger("Nation_Toggle_Open.CustomModelData");
		NATION_TOGGLE_TAX_PERCENTAGE = getString("Nation_Toggle_Tax_Percentage.Item");
		NATION_TOGGLE_TAX_PERCENTAGE_CMD = getInteger("Nation_Toggle_Tax_Percentage.CustomModelData");

		SET_NATION_SPAWN = getString("Set_Nation_Spawn.Item");
		SET_NATION_SPAWN_CMD = getInteger("Set_Nation_Spawn.CustomModelData");
		SET_NATION_BOARD = getString("Set_Nation_Board.Item");
		SET_NATION_BOARD_CMD = getInteger("Set_Nation_Board.CustomModelData");
		SET_NATION_NAME = getString("Set_Nation_Name.Item");
		SET_NATION_NAME_CMD = getInteger("Set_Nation_Name.CustomModelData");

		NATION_EXTRA_COMMANDS_1 = getString("Nation_Extra_Commands_1.Item");
		NATION_EXTRA_COMMANDS_1_CMD = getInteger("Nation_Extra_Commands_1.CustomModelData");
		...
		RESIDENT_LIST_CMD = getInteger("Resident_List.CustomModelData");
		PERMISSIONS_MENU = getString("Permissions_Menu.Item");
		PERMISSIONS_MENU_CMD = getInteger("Permissions_Menu.CustomModelData");
		ECONOMY_MENU = getString("Economy_Menu.Item");
		ECONOMY_MENU_CMD = getInteger("Economy_Menu.CustomModelData");
		PLOT_MENU = getString("Plot_Menu.Item");
		PLOT_MENU_CMD = getInteger("Plot_Menu.CustomModelData");
		SETTINGS_MENU = getString("Settings_Menu.Item");
		SETTINGS_MENU_CMD = getInteger("Settings_Menu.CustomModelData");
		INVITE_MENU = getString("Invite_Menu.Item");
		INVITE_MENU_CMD = getInteger("Invite_Menu.CustomModelData");
		...
		TOGGLE_PVP_CMD = getInteger("Toggle_PVP.CustomModelData");
		TOGGLE_PUBLIC = getString("Toggle_Public.Item");
		TOGGLE_PUBLIC_CMD = getInteger("Toggle_Public.CustomModelData");
		TOGGLE_OPEN = getString("Toggle_Open.Item");
		TOGGLE_OPEN_CMD = getInteger("Toggle_Open.CustomModelData");
		...
		RESIDENT_TITLE_CMD = getInteger("Resident_Title.CustomModelData");
		RESIDENT_RANK = getString("Resident_Rank.Item");
		RESIDENT_RANK_CMD = getInteger("Resident_Rank.CustomModelData");
		RESIDENT_MAYOR = getString("Resident_Mayor.Item");
		RESIDENT_MAYOR_CMD = getInteger("Resident_Mayor.CustomModelData");

		BUILD = getString("Build.Item");
		BUILD_CMD = getInteger("Build.CustomModelData");
		BREAK = getString("Break.Item");
		BREAK_CMD = getInteger("Break.CustomModelData");
		ITEM_USE = getString("Item_Use.Item");
		ITEM_USE_CMD = getInteger("Item_Use.CustomModelData");
		SWITCH = getString("Switch.Item");
		SWITCH_CMD = getInteger("Switch.CustomModelData");

		RESIDENT_BUILD = getString("Resident_Build.Item");
		RESIDENT_BUILD_CMD = getInteger("Resident_Build.CustomModelData");
		RESIDENT_BREAK = getString("Resident_Break.Item");
		RESIDENT_BREAK_CMD = getInteger("Resident_Break.CustomModelData");
		RESIDENT_ITEM_USE = getString("Resident_Item_Use.Item");
		RESIDENT_ITEM_USE_CMD = getInteger("Resident_Item_Use.CustomModelData");
		RESIDENT_SWITCH = getString("Resident_Switch.Item");
		RESIDENT_SWITCH_CMD = getInteger("Resident_Switch.CustomModelData");

		NATION_BUILD = getString("Nation_Build.Item");
		NATION_BUILD_CMD = getInteger("Nation_Build.CustomModelData");
		NATION_BREAK = getString("Nation_Break.Item");
		NATION_BREAK_CMD = getInteger("Nation_Break.CustomModelData");
		NATION_ITEM_USE = getString("Nation_Item_Use.Item");
		NATION_ITEM_USE_CMD = getInteger("Nation_Item_Use.CustomModelData");
		NATION_SWITCH = getString("Nation_Switch.Item");
		NATION_SWITCH_CMD = getInteger("Nation_Switch.CustomModelData");

		ALLY_BUILD = getString("Ally_Build.Item");
		ALLY_BUILD_CMD = getInteger("Ally_Build.CustomModelData");
		ALLY_BREAK = getString("Ally_Break.Item");
		ALLY_BREAK_CMD = getInteger("Ally_Break.CustomModelData");
		ALLY_ITEM_USE = getString("Ally_Item_Use.Item");
		ALLY_ITEM_USE_CMD = getInteger("Ally_Item_Use.CustomModelData");
		ALLY_SWITCH = getString("Ally_Switch.Item");
		ALLY_SWITCH_CMD = getInteger("Ally_Switch.CustomModelData");

		OUTSIDER_BUILD = getString("Outsider_Build.Item");
		OUTSIDER_BUILD_CMD = getInteger("Outsider_Build.CustomModelData");
		OUTSIDER_BREAK = getString("Outsider_Break.Item");
		OUTSIDER_BREAK_CMD = getInteger("Outsider_Break.CustomModelData");
		OUTSIDER_ITEM_USE = getString("Outsider_Item_Use.Item");
		OUTSIDER_ITEM_USE_CMD = getInteger("Outsider_Item_Use.CustomModelData");
		OUTSIDER_SWITCH = getString("Outsider_Switch.Item");
		OUTSIDER_SWITCH_CMD = getInteger("Outsider_Switch.CustomModelData");
		...
		DEPOSIT_CMD = getInteger("Deposit.CustomModelData");
		WITHDRAW = getString("Withdraw.Item");
		WITHDRAW_CMD = getInteger("Withdraw.CustomModelData");
		SET_TAX = getString("Set_Tax.Item");
		SET_TAX_CMD = getInteger("Set_Tax.CustomModelData");

		SET_TOWN_SPAWN = getString("Set_Town_Spawn.Item");
		SET_TOWN_SPAWN_CMD = getInteger("Set_Town_Spawn.CustomModelData");
		SET_HOME_BLOCK = getString("Set_Home_Block.Item");
		SET_HOME_BLOCK_CMD = getInteger("Set_Home_Block.CustomModelData");
		SET_TOWN_BOARD = getString("Set_Town_Board.Item");
		SET_TOWN_BOARD_CMD = getInteger("Set_Town_Board.CustomModelData");
		SET_TOWN_NAME = getString("Set_Town_Name.Item");
		SET_TOWN_NAME_CMD = getInteger("Set_Town_Name.CustomModelData");

		TOWN_CLAIM_INFO = getString("Town_Claim_Info.Item");
		TOWN_CLAIM_INFO_CMD = getInteger("Town_Claim_Info.CustomModelData");
		EXTRA_COMMANDS = getString("Extra_Commands.Item");
		EXTRA_COMMANDS_CMD = getInteger("Extra_Commands.CustomModelData");

		PLOT_TOGGLE_MENU = getString("Plot_Toggle_Menu.Item");
		PLOT_TOGGLE_MENU_CMD = getInteger("Plot_Toggle_Menu.CustomModelData");
		PLOT_PERMISSIONS_MENU = getString("Plot_Permissions_Menu.Item");
		PLOT_PERMISSIONS_MENU_CMD = getInteger("Plot_Permissions_Menu.CustomModelData");
		PLOT_ADMIN_MENU = getString("Plot_Admin_Menu.Item");
		PLOT_ADMIN_MENU_CMD = getInteger("Plot_Admin_Menu.CustomModelData");
		PLOT_FRIEND_MENU = getString("Plot_Friend_Menu.Item");
		PLOT_FRIEND_MENU_CMD = getInteger("Plot_Friend_Menu.CustomModelData");

		PLOT_TOGGLE_FIRE = getString("Plot_Toggle_Fire.Item");
		PLOT_TOGGLE_FIRE_CMD = getInteger("Plot_Toggle_Fire.CustomModelData");
		PLOT_TOGGLE_MOBS = getString("Plot_Toggle_Mobs.Item");
		PLOT_TOGGLE_MOBS_CMD = getInteger("Plot_Toggle_Mobs.CustomModelData");
		PLOT_TOGGLE_EXPLOSIONS = getString("Plot_Toggle_Explosions.Item");
		PLOT_TOGGLE_EXPLOSIONS_CMD = getInteger("Plot_Toggle_Explosions.CustomModelData");
		PLOT_TOGGLE_PVP = getString("Plot_Toggle_PVP.Item");
		PLOT_TOGGLE_PVP_CMD = getInteger("Plot_Toggle_PVP.CustomModelData");

		PLOT_BUILD = getString("Plot_Build.Item");
		PLOT_BUILD_CMD = getInteger("Plot_Build.CustomModelData");
		PLOT_BREAK = getString("Plot_Break.Item");
		PLOT_BREAK_CMD = getInteger("Plot_Break.CustomModelData");
		PLOT_ITEM_USE = getString("Plot_Item_Use.Item");
		PLOT_ITEM_USE_CMD = getInteger("Plot_Item_Use.CustomModelData");
		PLOT_SWITCH = getString("Plot_Switch.Item");
		PLOT_SWITCH_CMD = getInteger("Plot_Switch.CustomModelData");

		PLOT_RESIDENT_BUILD = getString("Plot_Resident_Build.Item");
		PLOT_RESIDENT_BUILD_CMD = getInteger("Plot_Resident_Build.CustomModelData");
		PLOT_RESIDENT_BREAK = getString("Plot_Resident_Break.Item");
		PLOT_RESIDENT_BREAK_CMD = getInteger("Plot_Resident_Break.CustomModelData");
		PLOT_RESIDENT_ITEM_USE = getString("Plot_Resident_Item_Use.Item");
		PLOT_RESIDENT_ITEM_USE_CMD = getInteger("Plot_Resident_Item_Use.CustomModelData");
		PLOT_RESIDENT_SWITCH = getString("Plot_Resident_Switch.Item");
		PLOT_RESIDENT_SWITCH_CMD = getInteger("Plot_Resident_Switch.CustomModelData");

		PLOT_NATION_BUILD = getString("Plot_Nation_Build.Item");
		PLOT_NATION_BUILD_CMD = getInteger("Plot_Nation_Build.CustomModelData");
		PLOT_NATION_BREAK = getString("Plot_Nation_Break.Item");
		PLOT_NATION_BREAK_CMD = getInteger("Plot_Nation_Break.CustomModelData");
		PLOT_NATION_ITEM_USE = getString("Plot_Nation_Item_Use.Item");
		PLOT_NATION_ITEM_USE_CMD = getInteger("Plot_Nation_Item_Use.CustomModelData");
		PLOT_NATION_SWITCH = getString("Plot_Nation_Switch.Item");
		PLOT_NATION_SWITCH_CMD = getInteger("Plot_Nation_Switch.CustomModelData");

		PLOT_ALLY_BUILD = getString("Plot_Ally_Build.Item");
		PLOT_ALLY_BUILD_CMD = getInteger("Plot_Ally_Build.CustomModelData");
		PLOT_ALLY_BREAK = getString("Plot_Ally_Break.Item");
		PLOT_ALLY_BREAK_CMD = getInteger("Plot_Ally_Break.CustomModelData");
		PLOT_ALLY_ITEM_USE = getString("Plot_Ally_Item_Use.Item");
		PLOT_ALLY_ITEM_USE_CMD = getInteger("Plot_Ally_Item_Use.CustomModelData");
		PLOT_ALLY_SWITCH = getString("Plot_Ally_Switch.Item");
		PLOT_ALLY_SWITCH_CMD = getInteger("Plot_Ally_Switch.CustomModelData");

		PLOT_OUTSIDER_BUILD = getString("Plot_Outsider_Build.Item");
		PLOT_OUTSIDER_BUILD_CMD = getInteger("Plot_Outsider_Build.CustomModelData");
		PLOT_OUTSIDER_BREAK = getString("Plot_Outsider_Break.Item");
		PLOT_OUTSIDER_BREAK_CMD = getInteger("Plot_Outsider_Break.CustomModelData");
		PLOT_OUTSIDER_ITEM_USE = getString("Plot_Outsider_Item_Use.Item");
		PLOT_OUTSIDER_ITEM_USE_CMD = getInteger("Plot_Outsider_Item_Use.CustomModelData");
		PLOT_OUTSIDER_SWITCH = getString("Plot_Outsider_Switch.Item");
		PLOT_OUTSIDER_SWITCH_CMD = getInteger("Plot_Outsider_Switch.CustomModelData");

		PLOT_RESET_ALL = getString("Plot_Reset_All.Item");
		PLOT_RESET_ALL_CMD = getInteger("Plot_Reset_All.CustomModelData");
		PLOT_ALL_ON = getString("Plot_All_On.Item");
		PLOT_ALL_ON_CMD = getInteger("Plot_All_On.CustomModelData");

		PLOT_ADMIN_FOR_SALE = getString("Plot_Admin_For_Sale.Item");
		PLOT_ADMIN_FOR_SALE_CMD = getInteger("Plot_Admin_For_Sale.CustomModelData");
		PLOT_ADMIN_NOT_FOR_SALE = getString("Plot_Admin_Not_For_Sale.Item");
		PLOT_ADMIN_NOT_FOR_SALE_CMD = getInteger("Plot_Admin_Not_For_Sale.CustomModelData");
		PLOT_ADMIN_SET_PLOT_TYPE = getString("Plot_Admin_Set_Plot_Type.Item");
		PLOT_ADMIN_SET_PLOT_TYPE_CMD = getInteger("Plot_Admin_Set_Plot_Type.CustomModelData");
		PLOT_ADMIN_EVICT_RES = getString("Plot_Admin_Evict_Res.Item");
		PLOT_ADMIN_EVICT_RES_CMD = getInteger("Plot_Admin_Evict_Res.CustomModelData");
	}
}
